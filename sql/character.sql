...
CREATE TABLE `char_character`  (
  ...
  `level` varchar(20) NULL DEFAULT NULL COMMENT '等级（如：3）',
  ...
  `char_desc` varchar(1024) NULL DEFAULT NULL COMMENT '部件组合中文说明',
  `desc_translations` text NULL COMMENT '汉字说明的多语种翻译',
...
CREATE TABLE `char_discrimination`  (
  ...
  `discrim_char_translations` text NULL COMMENT '辨析字说明的多语种翻译',
  `comparison_translations` text NULL COMMENT '对比辨析说明的多语种翻译',
...
CREATE TABLE `char_word`  (
  ...
  `level` varchar(20) NULL DEFAULT NULL COMMENT '组词HSK等级',
  `pinyin` varchar(100) NULL DEFAULT NULL COMMENT '组词拼音',
  `part_of_speech` varchar(50) NULL DEFAULT NULL COMMENT '词性',
  `word_item_translations` text NULL COMMENT '组词说明的多语种翻译',
  `example_sentence` text NULL COMMENT '中文例句',
  `example_pinyin` varchar(500) NULL DEFAULT NULL COMMENT '例句拼音',
  `example_translations` text NULL COMMENT '例句的多语种翻译',
  `example_image_id` bigint NULL DEFAULT NULL COMMENT '例句图片ID',
