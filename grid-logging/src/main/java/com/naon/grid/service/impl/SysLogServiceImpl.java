...
import com.naon.grid.repository.LogRepository;
import com.naon.grid.service.SysLogService;
import com.naon.grid.service.dto.SysLogQueryCriteria;
import com.naon.grid.service.dto.SysLogSmallDto;
import com.naon.grid.service.mapstruct.LogErrorMapper;
import com.naon.grid.service.mapstruct.LogSmallMapper;
...
public class SysLogServiceImpl implements SysLogService {
    ...
    public void save(String username, String browser, String ip, ProceedingJoinPoint joinPoint, SysLog sysLog) {
        ...
        com.naon.grid.annotation.Log aopLog = method.getAnnotation(com.naon.grid.annotation.Log.class);
    ...
    private JSONObject getParameter(Method method, Object[] args) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            if (requestBody != null) {
                // [el-async-1] ERROR o.s.a.i.SimpleAsyncUncaughtExceptionHandler - Unexpected exception occurred invoking async method: public void com.naon.grid.service.impl.SysLogServiceImpl.save(java.lang.String,java.lang.String,java.lang.String,org.aspectj.lang.ProceedingJoinPoint,com.naon.grid.domain.SysLog)
